...
export const Navbar: React.FC<NavbarProps> = ({
   ...
   *
   * IMPORTANT:
   * Both Panjika and Zodiac tabs are kept here.
   * This removes the previous Git merge conflict.
   */
  const tabs = [
    {
      id: 'daily',
    ...
    {
      id: 'horoscope',
      label: t('tab.horoscope'),
      icon: Compass,
    },
    {
      id: 'matchmaking',
      label: t('tab.matchmaking'),
      icon: HeartHandshake,
    },
    {
      id: 'numerology',
      label: t('tab.numerology'),
      icon: Hash,
    },
    {
      id: 'counsellor',
      label: t('tab.counsellor'),
  ...
  return (
    <header
      className={`sticky top - 0 z - 40 backdrop - blur - xl border - b shadow - 2xl transition - colors ${
  theme === 'dark'
    ? 'bg-[#0D0D0F]/80 border-[#2A2A2E]/80 text-[#E5E1D8]'
    : 'bg-[#F9F7F1]/85 border-[#E5E1D8] text-[#0D0D0F]'
} `}
    >
      {/* =========================================================
      ...
      <div
        className={`px - 4 py - 1.5 text - xs border - b flex items - center justify - between text - [#C9A050] / 90 overflow - x - auto ${
  theme === 'dark'
    ? 'bg-[#08080A] border-[#2A2A2E]/60'
    : 'bg-[#F0ECE1] border-[#E5E1D8]'
} `}
      >
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-xl font-bold tracking-wider text-[#F0ECE1]">
                  JYOTISH
                  <span className="text-[#C9A050]">VEDA</span>
                </span>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            >
              ...
              >
                ...
                <span className="font-semibold sm:hidden uppercase text-[11px]">
                  {currentLangObj.code}
                </span>
    ...
    : 'text-[#E5E1D8] hover:bg-[#1C1C22] hover:text-[#F0ECE1]'
                        ...
                        >
                          <div className="flex items-center space-x-2.5">
                            ...
                            <div>
                              <div className="font-medium text-xs text-[#F0ECE1]">
                                {lang.nativeName}
                              </div>

                              <div className="text-[10px] text-[#9E9A90]">
            ...
            <div
              className="relative flex items-center bg-[#141418] border border-[#2A2A2E] rounded-lg p-1.5 text-xs shadow-inner"
              ref={profileMenuRef}
            >
              ...
              >
                <span className="truncate">
                  ...
                  (
                  {currentProfile.horoscopeSystem === 'western'
                    ? 'Western'
                    : 'Vedic'}
                  )
                </span>
  ...
  theme === 'dark'
    ? 'border-[#2A2A2E]/60 bg-[#08080A]/60'
    : 'border-[#E5E1D8] bg-[#F9F7F1]/70'
} `}
      >
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <nav
            className="flex items-center justify-between py-2 w-full overflow-x-auto gap-1"
            aria-label="Tabs"
          >
            {tabs.map((tab) => {
              const Icon = tab.icon;
  ...
  isActive
    ...
    : `${theme === 'dark'
      ? 'text-[#9E9A90] hover:text-[#E5E1D8] hover:bg-[#1C1C22]'
      : 'text-[#6C6960] hover:text-[#0D0D0F] hover:bg-[#E5E1D8]'
    } hover:shadow-md hover:shadow-[#C9A050]/10`
} `}
                >
                  <Icon
                    className={`w - 4 h - 4 ${
